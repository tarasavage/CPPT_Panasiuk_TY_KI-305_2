...
public abstract class Pistol implements Fireable{
    private String name;
     ...
     */
    public Pistol(String name, double weight, Company company, Trigger trigger, Magazine magazine) {
        this.name = name;
        this.weight = weight;
     ...
     */
    public abstract void toggleSafety();
